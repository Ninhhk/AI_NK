...
def load_chat_history():
    ...
    if st.session_state.document_id:
        try:
            ...
            # Get history for this document from memory
            doc_id = st.session_state.document_id
            if doc_id not in st.session_state.in_memory_chat_history:
                st.session_state.in_memory_chat_history[doc_id] = []
            
            # Assign to chat_history
            st.session_state.chat_history = st.session_state.in_memory_chat_history[doc_id]
