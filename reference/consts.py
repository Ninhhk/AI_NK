LLM_MODEL_NAME = "Qwen2.5-14B-Instruct-Q4_K_M.gguf"
# LLM_MODEL_NAME = "orca-mini-3b-gguf2-q4_0.gguf"

PROMPT = """
Summarize the input text and arrange it in an array of JSON objects to to be suitable for a powerpoint presentation. The main language must be Vietnamese.
